# Generated by Django 5.2.8 on 2026-04-16 14:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.CharField(choices=[('Government', 'Government'), ('Private', 'Private')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_image', models.ImageField(blank=True, null=True, upload_to='verification/')),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Verified', 'Verified'), ('Accepted', 'Accepted'), ('Rejected', 'Rejected')], default='Pending', max_length=20)),
